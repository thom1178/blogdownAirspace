...
We will load in the data for the cities and states that I've lived. For the states, `0` indicates that I've never been, `1` indicats that I have visisted, and `2` indicates that I've lived in that state.
...
We need to ALSO load the shape files in order to create the states plot!

```{r shapefile}

statesSHP <- readOGR("cb_2017_us_state_500k.shp",
